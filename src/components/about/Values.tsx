...
const Values = () => {
    return (
        <div className="flex flex-col sm:flex-row gap-x-[2vw] px-[5vw] relative items-center justify-center mt-[5vw]">
            <div className="flex flex-col p-[3vw] bg-[#A0001B] relative w-[30vw] h-[35vw] sm:block hidden">
                <h1 className="font_britanica_bold text-[clamp(5vw,5vw,10rem)] leading-tight text-white w-[99%]">Our Core Values</h1>
                <Image src={compass} alt="Compass Icon" className="w-[60%] absolute bottom-0 left-0" />
            </div>

            <div
                className="overflow-y-auto h-[35vw] w-[60vw] relative flex flex-col sm:rounded-none rounded-xl bg-[#4F000D] sm:bg-white/20 p-[2vw] sm:p-[0]
            ...
            >
                ...
                <div className="group flex flex-col sm:items-start items-center sm:bg-white/20 sm:hover:bg-[#F9F2F3] transition-colors duration-300 ease-in-out cursor-pointer">
                    <h2 className="font_britanica_black text-[clamp(4vw,4vw,6rem)] sm:text-[clamp(3vw,3vw,4rem)] sm:p-[1vw] p-[2vw] text-white sm:text-[#4F4F4F] transition-colors duration-300 sm:group-hover:text-[#D4002C]">
                        Proactive & Practical Counsel
                    </h2>
                    <p className="font_britanica_regular text-[clamp(3.5vw,3.7vw,4rem)] sm:text-[clamp(1.5vw,1.5vw,4rem)] sm:p-[1vw] sm:px-[1vw] px-[2vw] text-white sm:text-[#4F4F4F] text-justify transition-colors duration-300 sm:group-hover:text-[#333333]">
