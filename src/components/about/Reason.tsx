...
const Reason = () => {
    return (
        <div className="flex flex-col items-center justify-center w-full  px-[5vw] mt-[5vw] gap-y-[2vw]">
            <h1 className="font_britanica_black bg-clip-text text-transparent bg-gradient-to-t from-black to-[#F20028] text-[clamp(3vw,3vw,4rem)]">Why Choose Us</h1>
            <div className="flex flex-col sm:flex-row items-center justify-between w-full gap-x-[3vw]">
                <div className="flex flex-col items-center gap-y-[1vw]">
                    ...
                    <Image src={shield} alt="Shield Icon" className="w-[2vw]  " />
                    </div>
                    <h2 className="font_britanica_black text-[clamp(4vw,4vw,3rem)] sm:text-[clamp(1.5vw,1.5vw,2rem)] text-[#4F4F4F] sm:text-black ">Experience-Driven Prevention</h2>
                ...
                <div className="flex flex-col items-center gap-y-[1vw] ">
                    <div className="flex items-center justify-center bg-[linear-gradient(180deg,_#A0001B_0%,_#3A000A_100%)] p-[1.5vw] rounded-full">
                    <Image src={dart} alt="Shield Icon" className="w-[2vw]  " />
                    </div>
                     <h2 className="font_britanica_black text-[clamp(4vw,4vw,3rem)] sm:text-[clamp(1.5vw,1.5vw,2rem)] text-[#4F4F4F] sm:text-black ">Result-Focused Advocacy</h2>
                ...
                <div className="flex flex-col items-center gap-y-[1vw] ">
                    <div className="flex items-center justify-center bg-[linear-gradient(180deg,_#A0001B_0%,_#3A000A_100%)] p-[1.5vw] rounded-full">
                    <Image src={atom} alt="Shield Icon" className="w-[2vw]  " />
                    </div>
                     <h2 className="font_britanica_black text-[clamp(4vw,4vw,3rem)] sm:text-[clamp(1.5vw,1.5vw,2rem)] text-[#4F4F4F] sm:text-black ">Agile & Forward-Thinking</h2>
