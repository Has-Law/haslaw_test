        ...
        <div className="bg-[#F2F2F2] min-h-screen w-full flex flex-col items-center">
            ...
            <div className="w-full relative h-[clamp(18rem,22vw,28rem)] flex items-center justify-center">
                ...
                <div className="absolute inset-0  flex flex-col items-center justify-center z-10 p-6 text-white">
                    ...
                    <p className="text-[clamp(0.85rem,4vw,1.2rem)] sm:text-[clamp(1vw,2vw,1.25rem)] max-w-4xl text-justify font_britanica_regular leading-relaxed opacity-90 drop-shadow-md">
                        We understand that every legal challenge is significant and often complex. Taking the first step to contact us is the key to finding clarity and a solution. Our team is ready to listen to your story.
                    </p>
                </div>
            </div>
                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                            <div>
                                ...
                                <input type="text" name="firstName" className="w-full duration-300 border-2 border-[#323232] rounded-xl px-4 py-3 text-[clamp(0.95rem,2.2vw,1.125rem)] focus:outline-none focus:ring-2 focus:ring-[#A0001B]/50 focus:border-[#A0001B]" placeholder="Enter Name" required />
                            </div>
                            <div>
                                ...
                                <input type="text" name="lastName" className="w-full duration-300 border-2 border-[#323232] rounded-xl px-4 py-3 text-[clamp(0.95rem,2.2vw,1.125rem)] focus:outline-none focus:ring-2 focus:ring-[#A0001B]/50 focus:border-[#A0001B]" placeholder="Enter your Last Name" required />
                            </div>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                            <div>
                                ...
                                <input type="email" name="email" className="w-full duration-300 border-2 border-[#323232] rounded-xl px-4 py-3 text-[clamp(0.95rem,2.2vw,1.125rem)] focus:outline-none focus:ring-2 focus:ring-[#A0001B]/50 focus:border-[#A0001B]" placeholder="Enter your Email Address" required />
                            </div>
                            <div>
                                ...
                                <div className="flex">
                                    <span className="inline-flex items-center px-3 text-lg text-white bg-black font_britanica_bold border-2 border-r-0 border-[#323232] rounded-l-xl ">+62</span>
                                    <input type="tel" name="phone" className="flex-1 duration-300 border-2 border-l-0 border-[#323232] rounded-r-xl px-4 py-3 text-[clamp(0.9rem,2.2vw,1rem)] focus:outline-none focus:ring-2 focus:ring-[#A0001B]/50 focus:border-[#A0001B]" placeholder="Enter phone numbers" required />
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <textarea name="message" className="w-full duration-300 border-2 border-[#323232] rounded-xl px-4 py-3 text-[clamp(0.95rem,2.2vw,1.125rem)] min-h-[clamp(8rem,30vw,20rem)] focus:outline-none focus:ring-2 focus:ring-[#A0001B]/50 focus:border-[#A0001B]" placeholder="Write your message here" required />
                        </div>
                    </div>
            ...
            <div className="w-full max-w-[83vw] mx-auto mt-16 mb-20 px-6 md:px-10">
                <iframe src={mapSrc} className="w-full h-[clamp(12rem,30vw,34rem)] rounded-2xl border-0" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    );
}