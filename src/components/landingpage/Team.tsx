        ...
        <div className="flex flex-col items-center gap-y-[2vw] mt-[4vw] w-[80%] mx-auto">
            ...
            <div className="flex flex-col items-center w-full">
                ...
                <div
                    ...
                    className={`relative overflow-hidden w-full cursor-pointer flex flex-row px-[5vw] items-center rounded-t-[2vw] py-[5vw] transition-all duration-300 ease-in-out ${hoveredSection === 'senior' ? 'justify-between' : 'justify-center'}`}
                >
                    ...
                    <h2 className={`z-10 font_britanica_black text-white text-[clamp(0.5rem,4vw,4rem)] py-[2vw] absolute transition-all duration-500 ease-in-out ${hoveredSection === 'senior' ? 'left-[5vw] -translate-x-0' : 'left-1/2 -translate-x-1/2'}`}>
                        SENIOR PARTNER
                    </h2>
                ...
                <div
                    ...
                    onMouseLeave={() => setHoveredSection(null)}
                    className={`relative overflow-hidden w-full cursor-pointer flex flex-row px-[5vw] items-center py-[5vw] border-t border-gray-400 border-b transition-all duration-300 ease-in-out ${hoveredSection === 'partner' ? 'justify-between' : 'justify-center'}`}
                >
                    ...
                    <h2 className={`z-10 font_britanica_black text-white text-[clamp(0.5rem,4vw,4rem)] py-[2vw] absolute transition-all duration-500 ease-in-out ${hoveredSection === 'partner' ? 'left-[5vw] -translate-x-0' : 'left-1/2 -translate-x-1/2'}`}>
                        PARTNER
                    </h2>
                    <div className="relative z-10 ml-auto">
                ...
                <Link
                    ...
                    onMouseLeave={() => setHoveredSection(null)}
                    className="relative overflow-hidden font_britanica_black text-white flex justify-center text-[clamp(0.5rem,4vw,4rem)] w-full items-center rounded-b-[2vw] py-[2vw]"
                >
