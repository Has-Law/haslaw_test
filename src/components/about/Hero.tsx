...
const Hero = () => {
 ...
 <div className="w-full bg-[linear-gradient(180deg,_#000000_0%,_#737373_100%)] h-[40vw] sm:hidden block"/>
    ...
    <div className="flex flex-col sm:items-start items-center sm:relative z-30 sm:w-[30vw] w-[70vw] transform sm:translate-x-[8vw] absolute -translate-x-1/2  left-1/2 sm:left-0 bottom-[5%] ">
        ...
        <h1 className="text-white sm:text-black font_britanica_black text-[clamp(5vw,5vw,7vw)] sm:text-[clamp(1rem,1.2vw,2rem)]">About</h1>
        <h1 className="bg-white sm:bg-black h-[0.1vw] sm:w-[2.4vw] w-[10vw]"/>
        </div>
        <h2 className="font_britanica_black text-[clamp(5vw,5vw,7vw)] sm:text-[clamp(2vw,2vw,2.4vw)] sm:text-start text-center sm:text-black text-white leading-tight">More Than a Law Firm, We Are Your Strategic Partner</h2>
    </div>
 </div>
 );
};
