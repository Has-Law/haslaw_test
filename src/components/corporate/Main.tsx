        ...
        <div className="flex-row flex justify-between w-full min-h-screen">
            <div className="flex flex-col mt-[5vw] px-[8vw] gap-y-[2vw] items-center">
                <div className="flex flex-col sm:flex-row items-start justify-start text-[#4F000D]">
                    <div className="flex flex-row gap-x-[2vw] items-start w-[23vw]">
                    ...
                    <div className="font_britanica_bold sm:font_britanica_regular lg:text-[clamp(1.3vw,1.3vw,4rem)] md:text-[clamp(1.5vw,1.5vw,4rem)] sm:text-[clamp(1.8vw,1.8vw,4rem)] space-y-[1.5vw] text-justify sm:w-[40vw]">
                        <p>
