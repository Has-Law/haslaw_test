...
const Footer = () => {
  return (
  <footer className="bg-white py-28 px-10 lg:px-32 font_britanica_regular">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-1 ml-20">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-[#4F000D] hover:text-[#7A0015] transition-colors text-xl">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-[#4F000D] hover:text-[#7A0015] transition-colors text-xl">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/member" className="text-[#4F000D] hover:text-[#7A0015] transition-colors text-xl">
                  Members
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/career" className="text-[#4F000D] hover:text-[#7A0015] transition-colors text-xl">
                  Careers
                </Link>
              </li>
              <li>
                <Link href="/pro-bono" className="text-[#4F000D] hover:text-[#7A0015] transition-colors text-xl">
                  Pro Bono
                </Link>
              </li>
            </ul>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/service/litigation" className="text-[#4F000D] hover:text-[#7A0015] transition-colors text-xl">
                  Litigation Services
                </Link>
              </li>
              <li>
                <Link href="/news" className="text-[#4F000D] hover:text-[#7A0015] transition-colors text-xl">
                  News & Insights
                </Link>
              </li>
              <li>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-5">
                ...
                <div>
                  <a href="mailto:info@has-law.com" className="text-[#4F000D] hover:text-[#7A0015] transition-colors text-xl">
                    info@has-law.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-5">
                ...
                <div>
                  <a href="tel:+622157905183" className="text-[#4F000D] hover:text-[#7A0015] transition-colors text-xl">
                    +6221 5790 5183
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-5">
                ...
                <div>
                  <a href="https://wa.me/6287867905183" className="text-[#4F000D] hover:text-[#7A0015] transition-colors text-xl">
                    +62 8786 790 5183
                  </a>
                </div>
              </div>
