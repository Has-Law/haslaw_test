...
const Values = () => {
    return (
        <div className="flex flex-col sm:flex-row gap-y-[4vw] sm:gap-y-0 sm:gap-x-[1.6vw] px-[5vw] relative items-center justify-center mt-[4vw]">
            ...
            <div className="hidden sm:flex flex-col p-[2.4vw] bg-[#A0001B] relative w-[32vw] h-[32vw]">
                <h1 className="font_britanica_bold text-[clamp(4vw,4vw,8rem)] leading-tight text-white w-[99%]">Our Core Values</h1>
                <Image src={compass} alt="Compass Icon" className="w-[70%] absolute bottom-0 left-0 " />
            </div>

            <div
                className="overflow-y-auto h-[80vw] sm:h-[32vw] w-full sm:w-[48vw] relative flex flex-col sm:rounded-none rounded-xl bg-[#4F000D] sm:bg-white/20 p-[3vw] sm:p-[0]
            ...
            >
                ...
                <div className="group flex flex-col sm:items-start items-center sm:bg-white/20 sm:hover:bg-[#F9F2F3] transition-colors duration-300 ease-in-out cursor-pointer">
                    <h2 className="font_britanica_black text-[clamp(4vw,4vw,6rem)] sm:text-[clamp(1vw,1.8vw,3.2rem)] sm:p-[0.8vw] p-[2vw] text-white sm:text-[#4F4F4F] transition-colors duration-300 sm:group-hover:text-[#D4002C]">
                        Proactive & Practical Counsel
                    </h2>
                    <p className="font_britanica_regular text-[clamp(3.5vw,3.7vw,4rem)] sm:text-[clamp(1.2vw,1.2vw,3.2rem)] sm:p-[0.8vw] sm:px-[0.8vw] px-[2vw] text-white sm:text-[#4F4F4F] text-justify transition-colors duration-300 sm:group-hover:text-[#333333]">
