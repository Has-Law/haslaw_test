    ...
    return (
        <div className=" flex flex-col items-center  relative aspect-[1280/549] mt-[5vw]">
            ...
            onMouseLeave={() => setIsHovered(false)}
             className={` font_britanica_black text-[clamp(1.5vw,1.5vw,4rem)] border-white border-[0.2vw] p-[1vw] rounded-full transition-colors duration-300 ease-in-out cursor-pointer ${isHovered ? 'bg-white text-[#A0001B]' : 'text-white'}`}>See Our Services</button>       
            </div>
        </div>
    );
}
