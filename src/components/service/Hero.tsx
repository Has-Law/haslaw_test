    ...
    return (
        <div className="relative aspect-[393/608] sm:aspect-[1280/529] flex flex-col justify-center ">
            ...
            <div className="relative z-10 flex flex-col w-[60vw] sm:w-[42vw] translate-x-1/8">
                ...
                <p className="font_britanica_bold sm:font_britanica_regular text-white text-[clamp(4vw,4vw,4rem)] sm:text-[clamp(1.3vw,1.3vw,4rem)] z-10">At HAS Attorneys at Law, our identity is forged through powerful and strategic litigation. We exist to win your most critical disputes, supported by robust corporate services that strengthen your legal standing.</p>
            </div>
        </div>
    )
}
