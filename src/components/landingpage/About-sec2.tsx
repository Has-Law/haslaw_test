    ...
    return (
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center 
            ...
            <div className="flex flex-col items-start gap-y-6 sm:gap-y-[2vw] sm:py-[2vw] w-full">
                ...
                <p className="font_britanica_regular text-base sm:text-[clamp(2vw,2vw,4rem)] text-gray-700 sm:text-[#131313] text-justify leading-relaxed">
                ...
                <Link
                    ...
                    className={`font_britanica_black 
                               text-base sm:text-[clamp(2vw,2vw,4rem)] 
