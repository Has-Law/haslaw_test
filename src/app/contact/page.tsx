...
export default function Contact() {
    ...
    return (
        <div className="bg-[#F2F2F2] min-h-screen w-full flex flex-col items-center">
            ...
            <div className="w-full relative h-[400px] md:h-[20vw] flex items-center justify-center">
                ...
                <div className="absolute inset-0  flex flex-col items-center justify-center z-10 p-6 text-white">
                    <h1 className="text-[clamp(3vw,3vw,5rem)] font_britanica_black mb-4 tracking-wide text-center drop-shadow-lg">Contact Us</h1>
                    <p className="text-[clamp(1vw,1.5vw,1.8rem)] max-w-4xl text-center font_britanica_regular leading-relaxed opacity-90 drop-shadow-md">
            ...
            <div className="w-full lg:max-w-[80vw] mx-auto flex flex-col lg:flex-row items-start justify-center mt-8  px-6 md:px-10">
                ...
                <form className="bg-white rounded-2xl shadow-2xl p-[clamp(1rem,5vw,3rem)] w-full lg:w-[65%] order-2 lg:order-1 flex-shrink-0">
                    <h2 className="text-[#780014] text-[clamp(2vw,2vw,2.5rem)] font_britanica_black mb-3">Send Us Message</h2>
                    <p className="text-gray-700 font_britanica_bold text-[clamp(1vw,1.5vw,1.5rem)] mb-8">Leave your message below, and let&apos;s start finding a solution together.</p>
                    ...
                    <button type="submit" className="bg-[#A0001B] text-white mt-8 px-10 py-4 rounded-full hover:bg-[#780014] transition-colors font_britanica_bold text-[clamp(0.875rem,2vw,1rem] shadow-md">Send Message</button>
                </form>
                ...
                <div className="bg-[#780014] text-white rounded-2xl shadow-2xl p-[clamp(2vw,2vw,3rem)] pb-[2.5vw] w-full lg:w-[40%] order-2 lg:order-2 flex-shrink-0 
                    ...
                    <h3 className="font_britanica_black mb-6 text-[clamp(2vw,2vw,2.75rem)]">Our Office</h3>
                    <div className="space-y-8">
                        <div className="flex items-start gap-4">
                          
                            <div>
                                <h4 className="font_britanica_bold font-bold text-lg mb-1">Address</h4>
                                <p className="text-white/90 font_britanica_regular break-words text-base leading-relaxed">
                        ...
                        <div className="flex items-start gap-4">
                            <div>
                                <h4 className="font_britanica_bold text-lg mb-1">Email</h4>
                                <p className="text-white/90 font_britanica_regular text-base">info@has-law.com</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            <div>
                                <h4 className="font_britanica_blacktext-lg mb-1">Telephone</h4>
                             
                                <div className="flex flex-col gap-2 mt-1">
                                    <div className="flex items-center gap-3">
                                        <Image src={phoneIcon} alt="Phone" className="w-6 h-6 opacity-80" />
                                        <p className="text-white/90 font_britanica_regular text-base">+6221 5790 5183</p>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <Image src={waIcon} alt="WhatsApp" className="w-6 h-6 opacity-80" />
                                        <p className="text-white/90 font_britanica_regular text-base">+62 8785 790 5183</p>
                                    </div>
                                </div>
                            </div>
                        </div>
