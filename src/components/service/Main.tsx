...
const Main = () => {
    return (
        <div className="mt-[3vw] gap-y-6 mb-6 relative px-[5vw] flex-col flex items-center justify-center">
            <h1 className="font_britanica_black text-[clamp(6vw,6vw,5rem)] sm:text-[clamp(3vw,3vw,4rem)] text-center leading-none">
