...
const Team = () => {
    ...
    return (
        <div className="flex flex-col items-center gap-y-[1.6vw]  w-[90%]  sm:w-[65%] mx-auto p-8">
            ...
            <div className="flex flex-col items-center w-full">
                ...
                >
                    ...
                    <div className={`hidden sm:flex flex-row px-6 sm:px-[4vw] items-center py-6 sm:py-[3vw] ${hoveredSection === 'partner' ? 'justify-between' : 'justify-center'}`}>
                        <h2 className={`z-10 font_britanica_black text-white text-2xl sm:text-[clamp(2.5vw,2.5vw,2.4rem)] py-4 sm:py-[1.6vw] absolute transition-all duration-500 ease-in-out ${hoveredSection === 'partner' ? 'left-6 sm:left-[4vw] -translate-x-0' : 'left-1/2 -translate-x-1/2'}`}>
                             PARTNER
                        </h2>
                    ...
                    <div className="sm:hidden flex flex-col  py-2">
                            ...
                            <div className={`grid transition-[grid-template-rows] duration-500 ease-in-out ${hoveredSection === 'partner' ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}>
                                <div className="overflow-hidden">
                                    <div className="flex flex-col gap-y-2 ">
                                        {partners.map((partner, index) => (
                                            <h3 key={index} className="font_britanica_bold text-white text-center text-clamp(3vw,3vw,5vw)">
                                                {partner.name}
                                            </h3>
                                        ))}
                                    </div>
                ...
                >
                    ...
                    <div className={`hidden sm:flex flex-row px-6 sm:px-[4vw] items-center py-6 sm:py-[3vw] ${hoveredSection === 'senior' ? 'justify-between' : 'justify-center'}`}>
                        <h2 className={`z-10 font_britanica_black text-white text-2xl sm:text-[clamp(2.5vw,2.5vw,2.4rem)] py-4 sm:py-[1.6vw] absolute transition-all duration-500 ease-in-out ${hoveredSection === 'senior' ? 'left-6 sm:left-[4vw] -translate-x-0' : 'left-1/2 -translate-x-1/2'}`}>
                           SENIOR PARTNER
                        </h2>
                        <div className="relative z-10 ml-auto">
                        ...
                        <div className="relative z-10">
                            <div className={`grid transition-[grid-template-rows] duration-500 ease-in-out ${hoveredSection === 'senior' ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}>
                                <div className="overflow-hidden">
                                    <div className="flex flex-col gap-y-2 ">
                                        {seniorPartners.map((partner, index) => (
                                            <h3 key={index} className="font_britanica_bold text-white text-center text-clamp(0.8rem,3vw,1.2rem)">
                                                {partner.name}
                                            </h3>
                                        ))}
                                    </div>
                ...
                <Link
                    ...
                    onMouseLeave={() => setHoveredSection(null)}
                    className="relative overflow-hidden font_britanica_black text-white flex justify-center text-2xl sm:text-[clamp(2.5vw,2.5vw,2.4rem)] w-full items-center rounded-b-xl sm:rounded-b-[1.6vw] py-4  sm:py-[1.6vw]"
                >
